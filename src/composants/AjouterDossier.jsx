  ...
  return (
    <div className="AjouterDossier">
      <Dialog open={ouvert} onClose={()=>setOuvert(false)} aria-labelledby="form-dialog-title">
        ...
        <DialogActions>
          <Button onClick={()=>{setOuvert(false); viderChamps()}} style={btnAnnuler} variant="outlined" color="primary">
            Annuler
          </Button>
          <Button onClick={() => {nom !== '' && gererAjout(nom, couverture, couleur); viderChamps(); }} style={btnAjouter} variant="outlined" color="primary">
            Ajouter
          </Button>
        </DialogActions>
      </Dialog>
