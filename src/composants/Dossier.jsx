...
import CouvertureVide from "../images/couverture.webp";
  ...
  return (
    <article className="Dossier" style={{backgroundColor: couleur}}>
      <div className="couverture">
        ...
        <img src={couverture? couverture: CouvertureVide} alt={nom}/>
      </div>
      <div className="info">
        <h2>{nom}</h2>
      ...
      <IconButton className="modifier" aria-label="modifier" size="small" aria-haspopup="true" onClick={handleClick}>
        <MoreVertIcon />        
      </IconButton>
      <Menu
        id="simple-menu"
